...
import org.springframework.cloud.sleuth.zipkin.web.ZipkinWebAutoConfiguration
import org.springframework.cloud.sleuth.zipkin.web.base.HttpMockServer
import org.springframework.cloud.sleuth.zipkin.web.base.MvcCorrelationIdSettingIntegrationSpec
...
import static org.springframework.cloud.sleuth.zipkin.web.correlationId.CorrelationIdHolder.CORRELATION_ID_HEADER

@ContextConfiguration(classes = [CorrelationIdAspectSpecConfiguration], loader = SpringApplicationContextLoader)
@ActiveProfiles("correlationid")
class CorrelationIdAspectISpec extends MvcCorrelationIdSettingIntegrationSpec {
	...
	@CompileStatic
	@Configuration
	@Import(ZipkinWebAutoConfiguration.RestTemplateConfig)
	@EnableAsync
	...
	static class CorrelationIdAspectSpecConfiguration {
		...
		ClientRequestInterceptor clientRequestInterceptor() {
			return Mockito.mock(ClientRequestInterceptor)
		}

		@Bean
		ClientResponseInterceptor clientResponseInterceptor() {
			return Mockito.mock(ClientResponseInterceptor)
		}
